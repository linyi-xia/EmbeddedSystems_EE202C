...
int main(){
    ...
    char* chunkof5;
    chunkof5 = (char*) malloc(6);
    char* beaconid;
    beaconid = (char*) malloc(5);
    char* turn;
    turn = (char*) malloc(5);
